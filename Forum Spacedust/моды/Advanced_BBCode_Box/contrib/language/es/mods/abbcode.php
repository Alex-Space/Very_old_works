...
* @version: $Id: abbcode.php, v 1.0.8 2008/05/01 05:01:00 leviatan21 Exp $
...
// bbcodes texts	
	...
	'ABBC3_FONT_VIEW'			=> '<span style="font-family:Comic Sans MS">Esto es una muestra de texto</span>',
	...
	'ABBC3_SIZE_VIEW'			=> '<span style="font-size: 150%; line-height: 116%;">Esto es una muestra de texto</span>',
	...
	'ABBC3_HIGHLIGHT_VIEW'		=> '<span style="background-color: yellow;">Esto es una muestra de texto</span>',
	...
	'ABBC3_COLOR_VIEW'			=> '<span style="color:red">Esto es una muestra de texto</span>',
...
//	'ABBC3_HIDE_VIEW'			=> '<dl class="hidebox"><dt class="hide">Mensaje Oculto:</dt><dd>Tienes que responder a este tema para ver el mensaje oculto.</dd></dl>',
	...
	'ABBC3_ALIGNJUSTIFY_VIEW'	=> '<div style="text-align:justify">Esto es una muestra de texto</div>',

	// Right Align
	'ABBC3_ALIGNRIGHT_MOVER'	=> 'Texto alineado a la derecha',
	'ABBC3_ALIGNRIGHT_TIP'		=> '[align=right]texto[/align]',
	'ABBC3_ALIGNRIGHT_VIEW'		=> '<div style="text-align:right">Esto es una muestra de texto</div>',

	// Center Align
	'ABBC3_ALIGNCENTER_MOVER'	=> 'Texto alineado al centro',
	'ABBC3_ALIGNCENTER_TIP'		=> '[align=center]texto[/align]',
	'ABBC3_ALIGNCENTER_VIEW'	=> '<div style="text-align:center">Esto es una muestra de texto</div>',

	// Left Align
	'ABBC3_ALIGNLEFT_MOVER'		=> 'Texto alineado a la izquierda',
	'ABBC3_ALIGNLEFT_TIP'		=> '[align=left]texto[/align]',
	'ABBC3_ALIGNLEFT_VIEW'		=> '<div style="text-left:justify">Esto es una muestra de texto</div>',
	...
	'ABBC3_B_VIEW'				=> '<strong>Esto es una muestra de texto</strong>',
	...
	'ABBC3_U_VIEW'				=> '<span style="text-decoration: underline">Esto es una muestra de texto</span>',

	// Strikethrough
	'ABBC3_S_MOVER'				=> 'Texto tachado',
	'ABBC3_S_TIP'				=> '[s]texto[/s]',
	'ABBC3_S_VIEW'				=> '<span style="text-decoration: line-through;">Esto es una muestra de texto</span>',
	...
	'ABBC3_DIRRTL_VIEW'			=> '<BDO dir="rtl">Esto es una muestra de texto</BDO>',
	...
	'ABBC3_DIRLTR_VIEW'			=> '<BDO dir="ltr">Esto es una muestra de texto</BDO>',

	// Marquee Down
	'ABBC3_MARQDOWN_MOVER'		=> 'Desplazamiento de texto hacia abajo',
	'ABBC3_MARQDOWN_TIP'		=> '[marq=down]texto[/marq]',
	'ABBC3_MARQDOWN_VIEW'		=> '<marquee direction="down" scrolldelay="120" height="80px">Esto es una muestra de texto</marquee>',

	// Marquee Up
	'ABBC3_MARQUP_MOVER'		=> 'Desplazamiento de texto hacia arriba',
	'ABBC3_MARQUP_TIP'			=> '[marq=up]texto[/marq]',
	'ABBC3_MARQUP_VIEW'			=> '<marquee direction="up" scrolldelay="120" height="80px">Esto es una muestra de texto</marquee>',

	// Marquee Right
	'ABBC3_MARQRIGHT_MOVER'		=> 'Desplazamiento de texto hacia la derecha',
	'ABBC3_MARQRIGHT_TIP'		=> '[marq=right]texto[/marq]',
	'ABBC3_MARQRIGHT_VIEW'		=> '<marquee direction="right" scrolldelay="120">Esto es una muestra de texto</marquee>',

	// Marquee Left
	'ABBC3_MARQLEFT_MOVER'		=> 'Desplazamiento de texto hacia la izquierda',
	'ABBC3_MARQLEFT_TIP'		=> '[marq=left]texto[/marq]',
	'ABBC3_MARQLEFT_VIEW'		=> '<marquee direction="left" scrolldelay="120">Esto es una muestra de texto</marquee>',
