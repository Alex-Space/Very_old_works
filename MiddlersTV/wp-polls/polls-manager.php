			...
			<table class="form-table">
				...
				<tbody>
					...
					<tr>
						<td width="20%">&nbsp;</td>
						<td width="60%">&nbsp;</td>
						<td width="20%" align="<?php echo $last_col_align; ?>"><strong><?php _e('Всего проголосовало:', 'wp-polls'); ?> <?php echo number_format_i18n($poll_totalvoters); ?></strong> <input type="text" size="4" name="pollq_totalvoters" value="<?php echo $poll_totalvoters; ?>" /></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="widefat">
				<thead>
					<tr>
						...
						<th><?php _e('Всего голосов', 'wp-polls'); ?></th>
